...
public  class ShowJobsForEmployer extends BaseActivity implements BusinessAdapter.OnBusinessInteractionListener {
    ...
    private void loadBusinesses() {
        ...
        databaseService.getBusinesss(new DatabaseService.DatabaseCallback<List<Business>>() {
            ...
            public void onFailed(Exception e) {
                ...
                Toast.makeText(ShowJobsForEmployer.this, "Failed to load businesses", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onDeleteBusinessClicked(Business business) {
        ...
        databaseService.removeBusiness(business.getId(), new DatabaseService.DatabaseCallback<Void>() {
            ...
            public void onCompleted(Void unused) {
                Toast.makeText(ShowJobsForEmployer.this, "העסק נמחק בהצלחה", Toast.LENGTH_SHORT).show();
                loadBusinesses();
            }
            ...
            @MainThread
            public void onFailed(Exception e) {
                Toast.makeText(ShowJobsForEmployer.this, "שגיאה במחיקת העסק: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onClickListener(Business business) {
        Intent intent = new Intent(ShowJobsForEmployer.this, JobsList.class);
